module AlphaBeta
    ...
    export get_alpha_t0_x_by_V0_Veq, get_alpha_by_proj_alphax_to_Qx, proj_vector_from_eigenspace_to_xspace, em_iteration, complete_em_v0, complete_em_only_update_peq, complete_em_only_update_peq_no_converge_test
